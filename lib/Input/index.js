      ...
      switch (value[0].toLowerCase()) {
        case /[a-c]/.test(value[0].toLowerCase()):
          ...
          if (countryIndex > -1) {
            ...
            countryOptions.push({
              label: { text: "A-C", type: "plain_text" },
        ...
        case /[d-j]/.test(value[0].toLowerCase()):
          ...
          if (countryIndex > -1) {
            ...
            countryOptions.push({
              label: { text: "D-J", type: "plain_text" },
              options: [{ text: value, value: id }],
            });
          }
          break;
        case /[k-o]/.test(value[0].toLowerCase()):
          ...
          if (countryIndex > -1) {
            ...
            countryOptions.push({
              label: { text: "K-O", type: "plain_text" },
              options: [{ text: value, value: id }],
            });
          }
          break;
        case /[p-s]/.test(value[0].toLowerCase()):
          ...
          if (countryIndex > -1) {
            ...
            countryOptions.push({
              label: { text: "P-S", type: "plain_text" },
              options: [{ text: value, value: id }],
            });
          }
          break;
        case /[t-z]/.test(value[0].toLowerCase()):
          ...
          if (countryIndex > -1) {
            ...
            countryOptions.push({
              label: { text: "T-Z", type: "plain_text" },
              options: [{ text: value, value: id }],
            });
          }
          break;
